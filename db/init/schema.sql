-- GENERATED BY @postpub/schema AT Sun Mar  6 08:07:28 PST 2022
\set ON_ERROR_STOP true
select set_config('postpub.app_pass', 'super secret', true);

-- SOURCE: 01.framework/00.banner.sql
...
-- SOURCE: 01.framework/01.roles.sql
...
-- SOURCE: 01.framework/02.extensions.sql
...
-- SOURCE: 02.world/01.country.sql
...
insert into country (
  name, official_name, sovereignty, code, alpha_3_code, numeric_code, tld
) values
...
('Antarctica ','Antarctica','Antarctic Treaty','AQ','ATA',10,'.aq'),
...
('Bahamas','The Commonwealth of The Bahamas','UN member state','BS','BHS',44,'.bs'),
...
('Bolivia','The Plurinational State of Bolivia','UN member state','BO','BOL',68,'.bo'),
('Saba','Bonaire, Sint Eustatius and Saba','Netherlands','BQ','BES',535,'.bq'),
...
('British Indian Ocean Territory','The British Indian Ocean Territory','United Kingdom','IO','IOT',86,'.io'),
('Brunei','The Nation of Brunei, the Abode of Peace','UN member state','BN','BRN',96,'.bn'),
...
('Cayman Islands','The Cayman Islands','United Kingdom','KY','CYM',136,'.ky'),
...
('Cocos Islands','The Territory of Cocos (Keeling) Islands','Australia','CC','CCK',166,'.cc'),
('Colombia','The Republic of Colombia','UN member state','CO','COL',170,'.co'),
('Comoros','The Union of the Comoros','UN member state','KM','COM',174,'.km'),
('Democratic Republic of the Congo','The Democratic Republic of the Congo','UN member state','CD','COD',180,'.cd'),
('Congo','The Republic of the Congo','UN member state','CG','COG',178,'.cg'),
('Cook Islands','The Cook Islands','New Zealand','CK','COK',184,'.ck'),
...
('Falkland Islands','The Falkland Islands','United Kingdom','FK','FLK',238,'.fk'),
('Faroe Islands','The Faroe Islands','Denmark','FO','FRO',234,'.fo'),
...
('French Southern Territories','The French Southern and Antarctic Lands','France','TF','ATF',260,'.tf'),
...
('Holy See','The Holy See','UN observer state','VA','VAT',336,'.va'),
('Honduras','The Republic of Honduras','UN member state','HN','HND',340,'.hn'),
('Hong Kong','The Hong Kong Special Administrative Region of China[10]','China','HK','HKG',344,'.hk'),
...
('Macao ','The Macao Special Administrative Region of China','China','MO','MAC',446,'.mo'),
('North Macedonia ','The Republic of North Macedonia','UN member state','MK','MKD',807,'.mk'),
...
('Northern Mariana Islands','The Commonwealth of the Northern Mariana Islands','United States','MP','MNP',580,'.mp'),
...
('Palestine, State of','The State of Palestine','UN observer state','PS','PSE',275,'.ps'),
...
('Saint Martin','The Collectivity of Saint-Martin','France','MF','MAF',663,'.mf'),
...
('Sint Maarten','Sint Maarten','Netherlands','SX','SXM',534,'.sx'),
...
('Jan Mayen','Svalbard and Jan Mayen','Norway','SJ','SJM',744,null),
...
('Taiwan','Taiwan','Disputed ','TW','TWN',158,'.tw'),
...
('Turks and Caicos Islands','The Turks and Caicos Islands','United Kingdom','TC','TCA',796,'.tc'),
...
('United States Minor Outlying Islands','Baker Island, Howland Island, Jarvis Island, Johnston Atoll, Kingman Reef, Midway Atoll, Navassa Island, Palmyra Atoll, and Wake Island','United States','UM','UMI',581,null),
('United States of America','The United States of America','UN member state','US','USA',840,'.us'),
...
('Western Sahara ','The Sahrawi Arab Democratic Republic','Disputed [ai]','EH','ESH',732,null),
